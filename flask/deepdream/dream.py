...
def mydream(img_in,guide_in,end_in):
    ...
    net.forward(end=end)
    guide_features = dst.data[0].copy()
    return deepdream(net, img, end=end, objective=objective_guide)
...
PIL.Image.fromarray(np.uint8(myoutput)).save("frames/teste4.jpg")
